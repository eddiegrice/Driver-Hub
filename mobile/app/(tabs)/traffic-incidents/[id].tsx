    ...
    return (
      <View style={styles.screen}>
        ...
        <View style={styles.centered}>
          <ThemedText style={styles.muted}>Alert not found.</ThemedText>
          <TouchableOpacity onPress={() => router.back()} style={styles.backBtn}>
            <ThemedText style={styles.link}>← Back to Incidents</ThemedText>
          </TouchableOpacity>
        </View>
      </View>
    );
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <GlassCard sleek borderRadius={Radius.lg} borderColor={LIGHT_EDGE} style={styles.card}>
          ...
          <ThemedText style={styles.title}>
            {situation.title ?? situationTypeLabel(situation.situationType) + ' – Traffic situation'}
          </ThemedText>
        ...
        <TouchableOpacity
          ...
          onPress={() => Linking.openURL(TRAFFIC_SCOTLAND_URL)}
          activeOpacity={0.8}
        >
