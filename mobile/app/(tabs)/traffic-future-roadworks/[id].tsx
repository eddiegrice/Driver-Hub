...
export default function FutureRoadworksDetailScreen() {
      ...
      <View style={styles.screen}>
        ...
        <View style={styles.centered}>
          ...
          <TouchableOpacity onPress={() => router.back()} style={styles.backBtn}>
            <ThemedText style={styles.link}>← Back to Future Roadworks</ThemedText>
          </TouchableOpacity>
        </View>
      </View>
    );
    ...
    <View style={styles.screen}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <GlassCard sleek borderRadius={Radius.lg} borderColor={LIGHT_EDGE} style={styles.card}>
          ...
          <ThemedText style={styles.title}>{situation.title ?? 'Planned roadworks'}</ThemedText>
